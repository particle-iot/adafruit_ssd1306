...
SSD1306_128x32::SSD1306_128x32(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS) : Adafruit_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
  cs = CS;
  rst = RST;
  dc = DC;
  sclk = SCLK;
...
SSD1306_128x32::SSD1306_128x32(int8_t DC, int8_t RST, int8_t CS) : Adafruit_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
  dc = DC;
  rst = RST;
  cs = CS;
  hwSPI = true;
...
void SSD1306_128x32::invertDisplay(uint8_t i) {
  if (i) {
...
void SSD1306_128x32::startscrollright(uint8_t start, uint8_t stop){
...
// Hint, the display is 16 rows tall. To scroll the whole display, run:
// display.scrollright(0x00, 0x0F) 
void SSD1306_128x32::startscrollleft(uint8_t start, uint8_t stop){
...
// Hint, the display is 16 rows tall. To scroll the whole display, run:
// display.scrollright(0x00, 0x0F) 
void SSD1306_128x32::startscrolldiagright(uint8_t start, uint8_t stop){
...
// Hint, the display is 16 rows tall. To scroll the whole display, run:
// display.scrollright(0x00, 0x0F) 
void SSD1306_128x32::startscrolldiagleft(uint8_t start, uint8_t stop){
	ssd1306_command(SSD1306_SET_VERTICAL_SCROLL_AREA);	
	ssd1306_command(0X00);
	ssd1306_command(SSD1306_LCDHEIGHT);
...
void SSD1306_128x32::stopscroll(void){
...
void SSD1306_128x32::dim(bool dim) {
  uint8_t contrast;
...
void SSD1306_128x32::ssd1306_data(uint8_t c) {
  if (sid != -1)
  {
    // SPI
    digitalWrite(cs, HIGH);
